 ...
 */
export function roundCommands(cmds: SVGCommand[], r: number | number[], round?: number): { path: string; commands: SVGCommand[] }
 ...
 */
export function roundCorners(str: string, r: number | number[], round?: number): { path: string; commands: SVGCommand[] }
